...
trait Updatable1[V1] extends Values1[V1] {
  ...
  def ptrUpdate1[@specialized W1](ptr: VPtr[Updatable1.this.type], v: W1): Unit

  def ptrUpdate1FromArray(ptr: VPtr[Updatable1.this.type], array: Array[_], i: Int): Unit =
    array match {
      ...
      case a: Array[Unit] => ptrUpdate1[Unit](ptr, a.asInstanceOf[Array[Unit]](i))
